...
public interface CollectInterfaceTest {
    ...
    @Test
    @DisplayName("test summarize collection with bad input")
    ...
    @Test
    @DisplayName("test summarize collection with empty inputs")
    ...
    @Test
    @DisplayName("test summarize collection with negative number inputs")
